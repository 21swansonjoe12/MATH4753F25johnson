...
#' @param mu vector of test values for mu (use seq())
#' @param sig vector of test values for sigma (use seq())
#' @param ... graphical paramters
#' @importFrom graphics contour
#' @importFrom stats sd
#'
#' @returns the sample, a matrix of the indexes where the MLE was found, and the maximum likelihood
#' @export
#'
#' @examples
